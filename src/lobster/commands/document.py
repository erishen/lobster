...
@click.option('--method', type=click.Choice(['recursive', 'character']), default='recursive', help='Splitting method')
def split(file_path, chunk_size, chunk_overlap, method):
    ...
    try:
        ...
        console.print(f"[dim]Chunk size: {chunk_size}, Overlap: {chunk_overlap}, Method: {method}[/]")
